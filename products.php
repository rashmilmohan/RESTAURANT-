...
<footer class="section footer">
    ...
    <div class="footer-icons">
      ...
      <a href="https://www.github.com" class="" target="_blank"><i class="fab fa-github footer-icon"></i></a>
      <a href="https://www.linkedin.com" target="_blank" class=""><i class="fab fa-linkedin footer-icon"></i></a>
      <a href="https://www.twitter.com" class="" target="_blank"><i class="fab fa-twitter footer-icon"></i></a>
    </div>

    <!-- copyright -->
    <p class="copyright">
      copyright &copy;Resturant <span id="date"></span>. all right reserved
    </p>
  </footer>
  <!-- end of footer -->
